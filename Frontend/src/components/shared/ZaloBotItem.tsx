...
interface ZaloBotItemProps {
    item: ZaloBot;
    onEdit: (item: ZaloBot) => void;
}

export function ZaloBotItem({ item, onEdit }: ZaloBotItemProps) {
    ...
    return (
        <>
            <Item variant="outline" className="p-3 sm:p-4">
                <MessageCircle className="h-5 w-5 sm:h-6 sm:w-6 text-blue-500 shrink-0" />
                ...
                <DialogContent className="max-w-sm sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-sm">
                            Bạn có chắc chắn muốn xóa Zalo Bot "{item.bot_name}"? Hành động
...
export const ZaloBotItemSkeleton = () => {
    return (
