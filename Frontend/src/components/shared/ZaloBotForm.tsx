...
interface ZaloBotFormProps {
  onFinished: () => void;
  editData?: ZaloBot | null;
}

export function ZaloBotForm({ onFinished, editData }: ZaloBotFormProps) {
  const { createBot, isCreatingBot, updateBot, isUpdatingBot } = useZaloBots();
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription className="text-xs">
                Access Token từ Zalo OA (bắt buộc)
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
